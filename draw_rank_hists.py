...
"""Draw histograms obtained by make_rank_hist on a single plot."""
...
def main(argv=None):
    parser = argparse.ArgumentParser(
        description="Draw histrograms obtained by make_rank_hist."
    )
    parser.add_argument(
    ...
    pyplot.xlabel("Compositional bias rank", fontsize=10)
